...
async def change_equipe(reader, writer, player):
    writer.write(f"{DISPLAY_BYTE_ID}|Player object before changing team: {player.equipe}".encode())
    print(f"Player object before changing team: {player.equipe}")  # Debugging log

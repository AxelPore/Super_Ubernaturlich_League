...
class Player :
    ...
    def register(self, username, mdp, starter_pokemon):
        ...
        cursor.execute("INSERT INTO Pokemon (PokemonName, Userid, Ability, Move1, Move2, Move3, Move4, Pokedexid, Level, Exp, Needed_exp, Stat_hp, Stat_attack, Stat_defense, Stat_spattack, Stat_spdefense, Stat_speed, Stat_hp_ev, Stat_attack_ev, Stat_defense_ev, Stat_spattack_ev, Stat_spdefense_ev, Stat_speed_ev, Max_ev, Stat_hp_iv , Stat_attack_iv, Stat_defense_iv, Stat_spattack_iv, Stat_spdefense_iv, Stat_speed_iv) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (first_pokemon.pokemon_name, self.userid, first_pokemon.ability[0], moves[0][0], moves[1][0], moves[2][0], moves[3][0], pokedexid, 5, 0, first_pokemon.get_needed_exp(5, first_pokemon.exp_curve), first_pokemon.get_stat_hp(5,first_pokemon.hp, first_pokemon.hp_iv, first_pokemon.hp_ev), first_pokemon.get_stat(5,first_pokemon.stats[0], first_pokemon.stats_iv[0], first_pokemon.stats_ev[0]), first_pokemon.get_stat(5,first_pokemon.stats[1], first_pokemon.stats_iv[1], first_pokemon.stats_ev[1]), first_pokemon.get_stat(5,first_pokemon.stats[2], first_pokemon.stats_iv[2], first_pokemon.stats_ev[2]), first_pokemon.get_stat(5,first_pokemon.stats[3], first_pokemon.stats_iv[3], first_pokemon.stats_ev[3]), first_pokemon.get_stat(5,first_pokemon.stats[4], first_pokemon.stats_iv[4], first_pokemon.stats_ev[4]), first_pokemon.hp_ev, first_pokemon.stats_ev[0], first_pokemon.stats_ev[1], first_pokemon.stats_ev[2], first_pokemon.stats_ev[3], first_pokemon.stats_ev[4], first_pokemon.hp_iv, first_pokemon.stats_iv[0], first_pokemon.stats_iv[1], first_pokemon.stats_iv[2], first_pokemon.stats_iv[3], first_pokemon.stats_iv[4]))

...
class Battle :
    def __init__(self, player1, player2):
        ...
        self.equipe2 = player2.get_equipe()
    
    def changes_pokemon(self, number, pokemon):
        if number == 1:
    ...
    def pokemon_moves(self, number): #Renvoi les moves du pokemon sur le terrain (1 ou 2)
        if (number == 1):
            return self.pokemon1.get_moves()
        elif (number == 2):
            return self.pokemon2.get_moves()
        else :
            return "Nombre invalide"
        
    def use_skill(self, number, skill_name): 
        if (number == 1):
    ...
    def end_turn(self, move_data1, move_data2):
